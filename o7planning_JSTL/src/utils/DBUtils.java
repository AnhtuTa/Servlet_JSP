...
public class DBUtils {
	...
	private static void initData() {
		...
		Dept technicalDept = new Dept(50, "Techical", "Hanoi");
		technicalDept.addEmployee(new Emp(8101, "Ta Anh Tu", "Electronics Engineer", "09/14/2017", 2100));
		technicalDept.addEmployee(new Emp(8121, "Nguyen Bka", "IT Engineer", "09/21/2015", 2800));
		
		Dept humanResourcesDept = new Dept(60, "Human Resources", "Đà Nẵng");
		humanResourcesDept.addEmployee(new Emp(9001, "Tran Van Thanh Toan", "Secretary", "22/11/2012", 1720.3f));
		humanResourcesDept.addEmployee(new Emp(9302, "Tran Quang Huy", "Leader", "20/02/2012", 1691.3f));
		
		DEPARTMENTS.add(accountingDept);
		DEPARTMENTS.add(reseachDept);
		DEPARTMENTS.add(salesDept);
		DEPARTMENTS.add(openrationsDept);
		DEPARTMENTS.add(technicalDept);
		DEPARTMENTS.add(humanResourcesDept);
	}
